...
![Model indexing example](https://github.com/IntelCompH2020/EWB/blob/main/static/Images/index_model.png)
...
![Collection corpora after indexing corpus and model](https://github.com/IntelCompH2020/EWB/blob/main/static/Images/corpora_after_model_indexing.png)
...
|  Query  | **Endpoint**                   | **Description**                                                                                                                                                                                         | **Returns**                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| :-----: | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
